...
const DeductionSalesCreate = () => {
  const config = MASTER_CONFIG.deduction_sales;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage('Deduction Sales saved successfully!');
      ...
      setMessage('Error saving deduction sales');
      setMessageType('error');
    } finally {
      setLoading(false);
    }
  ...
  return (
    <MasterFormLayout title="Deduction Sales Creation" onSave={handleSubmit} onCancel={handleCancel}>
...
export default DeductionSalesCreate;
