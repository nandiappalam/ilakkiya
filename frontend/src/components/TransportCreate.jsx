...
const TransportCreate = () => {
  const config = MASTER_CONFIG.transport;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage('Error saving transport');
      setMessageType('error');
    } finally {
      setLoading(false);
    }
  ...
  return (
    <MasterFormLayout title="Transport Creation" onSave={handleSubmit} onCancel={handleCancel}>
