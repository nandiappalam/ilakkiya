...
const PapadCompanyCreate = () => {
  const config = MASTER_CONFIG.papad_company || MASTER_CONFIG.company || {};  // fallback if not defined
  ...
  return (
    <MasterFormLayout title="Papad Company Creation" onSave={handleSubmit} onCancel={handleCancel}>
