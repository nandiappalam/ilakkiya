...
import './SenderCreate.css';

const SenderCreate = () => {
  const config = MASTER_CONFIG.sender;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage('Sender saved successfully!');
      ...
      setMessage('Error saving sender');
      setMessageType('error');
    } finally {
      setLoading(false);
    }
  ...
  return (
    <MasterFormLayout title="Sender Creation" onSave={handleSubmit} onCancel={handleCancel}>
