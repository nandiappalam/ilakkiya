...
import './ItemGroupCreate.css';

const ItemGroupCreate = () => {
  const config = MASTER_CONFIG.item_group;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage('Item Group saved successfully!');
      ...
      setMessage('Error saving item group');
      setMessageType('error');
    } finally {
      setLoading(false);
    }
  ...
  return (
    <MasterFormLayout title="Item Group Creation" onSave={handleSubmit} onCancel={handleCancel}>
